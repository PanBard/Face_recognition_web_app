...
@Component({
  ...
  <div *ngIf="!user_login" class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      <!-- <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
          <img class="w-8 h-8 mr-2 bg-white" src="/assets/images/pine.svg" alt="logo">
          Noow    
      </a> -->
...
export class LogInComponent {
    constructor(private router: Router, private userLoginService: GlobalVarableStoreService){
        this.checkLogin(); 
    }
    user_login: any;
    ...
    checkLogin() {
      ...
      logOut() {
        this.userLoginService.removeCurrentUser();
        this.user_login = null;
      }


    change_route(){
        this.router.navigate(['/loginViaWebcam']);
